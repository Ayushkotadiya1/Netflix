...
const Header = () => {
  return (
    <div className='w-[100%] h-[100vh] bg-[url("../../public/images/main.jpg")]'>
      <div className='w-[100%] h-[100vh] bg-[rgba(0,0,0,0.5)]'>
        <header className='max-w-[1170px] mx-auto'>
          <div className='grid sm:grid-cols-2 grid-cols-[30%_auto] px-[10px] items-center'>
            <figure>
              <img src="../../public/images/NetflixLogo.png" alt="" className='w-[148px]' />
            </figure>
            <div className='flex justify-end gap-[10px]'>
              ...
              <button className='bg-[red] px-[10px] rounded-[5px] text-white'>Sign In</button>
            </div>
          </div>
        </header>
        <div className='text-white max-w-[1170px] text-center sm:py-[150px] py-[65px] px-[30px] mx-auto'>
          <h1 className='sm:text-[45px] text-[30px] font-extrabold '>The biggest Indian hits. Ready to watch here from ₹149.</h1>
          <h4 className='text-[28px] py-[10px]'>Join today. Cancel anytime.</h4>
          <InputSection />
        </div>
      </div>
    </div>
